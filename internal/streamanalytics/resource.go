...
// =====================================================
// WS-7.2 — Streaming Analytics as declarative resources
//
// StreamJobResource defines a real-time windowed aggregation job
// over Kafka/event bus streams. The reconciler manages the job
// lifecycle (start, checkpoint, stop).
// =====================================================
